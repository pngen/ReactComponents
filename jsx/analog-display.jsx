const AnalogDisplay = props => {
	...
	let secondHandStyle = {
		...
		height: 1,
		transform:
			"rotate(" + ((date.getSeconds() / 60) * 360 - 90).toString() + "deg)", // Calculates angle and rotates the second hand with minus 90 to offset for the hand's starting horizontal position
